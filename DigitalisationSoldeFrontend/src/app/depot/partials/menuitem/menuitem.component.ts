...
export class MenuitemComponent implements OnInit, OnDestroy {
    ...
    constructor(public layoutService: DlayoutService, private cd: ChangeDetectorRef, public router: Router,private appSidebar: SidebarComponent, private menuService: MenuService) {
