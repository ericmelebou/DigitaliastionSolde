...
export class DlayoutComponent implements OnDestroy {
  ...
  constructor(private menuService: MenuService, public layoutService: DlayoutService, public renderer: Renderer2, public router: Router) {
